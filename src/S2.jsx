...
const S2 = ({isSelected}) => {
    ...
    useEffect(() => {
      ...
      .then(response => {
        ...
        axios.get('http://localhost:8080/student/2/'+localStorage.getItem("apogee"))
      .then(response => {
        console.log("data:",response.data)
      ...
      const handleSubmit = async (e) => {
        ...
        try {
          ...
          `;
          console.log("selcet student:",selectStudent2);
    
          const response = await axios.post('http://localhost:5104/inscrit/2', xmlData, {
            headers: {
  ...
  return (
    <div className={`${isSelected === "S2" ? "block": "hidden"} w-[90%] flex mx-auto flex-row gap-2`}>
        
    <div className='flex-1'>
    <h3 className='text-center text-gray-600 uppercase text-xl leading-normal m-10 font-bold'>Semester 2</h3>
    ...
    <table className="min-w-max w-full table-auto">
        <thead>
          <tr className="bg-blue-400 border-b-4 border-gray-200 uppercase text-sm leading-normal">
