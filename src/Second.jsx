...
const Second = ({isSelected}) => {
  return (
    <div className={`${isSelected === "second" ? "block": "hidden"} w-[80%] mx-auto`}>
        <h3 className='text-center text-gray-600 uppercase text-xl leading-normal m-10 font-bold'>Semestre 2</h3>
