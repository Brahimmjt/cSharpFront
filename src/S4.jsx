...
const S4 = ({isSelected}) => {
    ...
    useEffect(() => {
      ...
      .then(response => {
        ...
        axios.get('http://localhost:8080/student/4/'+localStorage.getItem("apogee"))
      .then(response => {
        console.log("data:",response.data)
      ...
      const handleSubmit = async (e) => {
        ...
        try {
          ...
          `;
          console.log("selcet student:",selectStudent);
    
          const response = await axios.post('http://localhost:5104/inscrit/4', xmlData, {
            headers: {
  ...
  return (
    <div className={`${isSelected === "S4" ? "block": "hidden"} w-[90%] flex mx-auto flex-row gap-2`}>
        
    <div className='flex-1'>
    <h3 className='text-center text-gray-600 uppercase text-xl leading-normal m-10 font-bold'>Semester 4</h3>
