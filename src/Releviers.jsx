  ...
  return (
    <div className="w-full">
      <div className="bg-white shadow-md rounded flex flex-row gap-5 w-[50%] mx-auto text-center">
        <div className={`${selectedPage === "first" ? "bg-green-300" : "bg-white"} flex-1 border-b-4 border-green-500 p-4`} onClick={() => handleClick("first")}>
          <p className="text-gray-600 uppercase text-lg leading-normal font-semibold">Semestre 1</p>
        </div>
        <div className={`${selectedPage === "second" ? "bg-green-300" : "bg-white"} flex-1 border-b-4 border-green-500 p-4`} onClick={() => handleClick("second")}>
          <p className="text-gray-600 uppercase text-lg leading-normal font-semibold">Semestre 2</p>
        </div>
        <div className={`${selectedPage === "third" ? "bg-green-300" : "bg-white"} flex-1 border-b-4 border-green-500 p-4`} onClick={() => handleClick("third")}>
