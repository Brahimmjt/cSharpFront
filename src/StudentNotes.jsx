  ...
  return (
    <div className="w-full">
      <div className="bg-white shadow-md rounded flex flex-row gap-5 w-[50%] mx-auto text-center">
        <div className={`${selectedPage === "S1" ? "bg-pink-300" : "bg-white"} flex-1 border-b-4 border-pink-500 p-4`} onClick={() => handleClick("S1")}>
          <p className="text-gray-600 uppercase text-lg leading-normal font-semibold">Semestre 1</p>
        </div>
        <div className={`${selectedPage === "S2" ? "bg-blue-300" : "bg-white"} flex-1 border-b-4 border-blue-500 p-4`} onClick={() => handleClick("S2")}>
          <p className="text-gray-600 uppercase text-lg leading-normal font-semibold">Semestre 2</p>
        </div>
        <div className={`${selectedPage === "S3" ? "bg-yellow-300" : "bg-white"} flex-1 border-b-4 border-yellow-500 p-4`} onClick={() => handleClick("S3")}>
          <p className="text-gray-600 uppercase text-lg leading-normal font-semibold">Semestre 3</p>
        </div>
        <div className={`${selectedPage === "S4" ? "bg-green-300" : "bg-white"} flex-1 border-b-4 border-green-500 p-4`} onClick={() => handleClick("S4")}>
